...
public class VegetableBuilder {
    ...
    public static Vegetable GetPotato() =>
        new Vegetable("Картофель", null, null, "Картофель обычно растет от 90 до 120 дней.", VegetableType.TuberCrop);
    ...
    public static Vegetable GetCarrot() =>
        new Vegetable("Морковь", null, null, "Морковь растет от 2 до 3 месяцев.", VegetableType.RootVegetables);
    ...
    public static Vegetable GetCabbage() =>
        new Vegetable("Капуста", null, null, "Капуста растет от 45 до 60 дней.", VegetableType.LeafyVegetables);

    public static IEnumerable<Vegetable> GetAll() {
        List<Vegetable> vegetables = [GetPotato(), GetCarrot(), GetCabbage()];
        return vegetables;
    }
}
